export const data=[
    {
        ...
        li:"Design attrayant et sur mesure; Hébergement gratuit pendant 1 an; Nom de domaine gratuit pendant 1 an;Certificat SSL inclus;Assistance gratuite pendant les 2 premières semaines;Site responsive(Tablette, Téléphone, ordinateur),Pages, Articles,Intégration reseaux sociaux",
        duree:"3jours"
    },
    {
    ...
    {
        iconentreprise:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_myc1UgpbvYxmILvvM4aABO6cDVIecDnXuw&s",
        prix:"$250",
        nom:"PWA",
    ...
    {
        iconentreprise:"https://www.kiwili.com/wp-content/uploads/2018/05/Logiciel-de-gestion-en-ligne-1.jpg",
        prix:"$270",
